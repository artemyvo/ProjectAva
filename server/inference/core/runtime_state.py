...
class ModelRuntime:
    ...
    # True while the startup auto-load is in flight (2026-09-11). The server LISTENS
    # before it loads, so a client can connect mid-load and must be told "loading"
    # rather than "no model"; handle_load refuses a second load meanwhile.
    loading: bool = False

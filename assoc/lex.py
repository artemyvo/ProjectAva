...
since still yet even much many well way thing things something anything nothing every ever
never always often already rather quite though although whether either neither around within
without upon toward towards per via really actually maybe perhaps
""".split())
STOP_RU = frozenset("""
самый самая самое самом самой самых самые сами сам сама само

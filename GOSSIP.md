...
> (or the Encounter tab pointed at the peer with gossip framing pasted in). Tested
> end-to-end between two live boxes, the main box ↔ a second box (§4.6). Still deferred:
...
- [x] Acceptance test §4.6 (point an Encounter tab at the serving box) — run between
      the main box and a second box; the second box was brought up for this.
